// Vector.h -- Class definition for Vector, a class of homogenous vectors

/* this file has been taken from MTW project by Abed 		*/
/* I added one more function. Vector interpolation			*/
/* function. It is required to do trilinear interploation 	*/
