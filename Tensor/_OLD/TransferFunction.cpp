...
__m128 TransferFunction::getValue(__m128 m128_Intensity){
	...
	for(int i = 0 ; i < 4 ; i++){			// process for each component	
		float a = (float)(m128_Intensity.m128_f32[i]) ; 
		...
		m128_LowValX.m128_f32[i] =  pointList[point-1][0] ;
		m128_HighValX.m128_f32[i] =  pointList[point][0] ;

		m128_LowValY.m128_f32[i] =  pointList[point-1][1] ;
		m128_HighValY.m128_f32[i] =  pointList[point][1] ;
	}
