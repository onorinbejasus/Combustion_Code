...
void Transform::RightMult(Vector4& vRight, Vector4& vResult)
{
    ...
    assert(1.0f == vResult.fVector[3].m128_f32[0]);
    assert(1.0f == vResult.fVector[3].m128_f32[1]);
    assert(1.0f == vResult.fVector[3].m128_f32[2]);
    assert(1.0f == vResult.fVector[3].m128_f32[3]);
}
...
Vector& Transform::SolveForAngles(void)
{
    ...
    return vOrientation = Vector(-dXrotation, -dYrotation, -dZrotation);
}
//*/
