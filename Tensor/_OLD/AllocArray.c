...
/*
// define special unions for manipulating hardware addresses
union AA_Pointer_32
{
    void*           VoidPointer;
...
#else
                "\n***** Unable to allocate memory block of %I32u bytes.\n",
#endif
...
#else
    cpData  = (char*)(((unsigned int)cpData) & 0xffffffc0);     // round back to 64-byte boundary
#endif
